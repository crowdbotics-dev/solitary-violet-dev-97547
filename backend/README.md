...
## Project Structure
    ...
    ├── solitary_violet_dev_97547  # Django project configurations
...
1. Clone this repo and `cd solitary_violet_dev_97547`
...
2. Clone this repo and `cd solitary_violet_dev_97547`
